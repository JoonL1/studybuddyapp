...
const OnboardingScreen = () => {
  ...
  const activeScreenIndex = 2; // Change this index based on the current active screen
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={[styles.headerText, headline.large]}>Ditch HAC, view grades at a glance</Text>
      </View>
      ...
      <View style={styles.imageContainer}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor: tertiary.complement,
              borderRadius: 32,
              paddingVertical: 40,
              width: Dimensions.get('window').width, // Set the width of the image container
            },
          ]}
        >
        </View>
        <Image
            source={require('../../assets/graphics/onboarding/onboarding3.png')}
        ...
        <View style={styles.textContainer}>
          ...
          Why bother logging in to HAC when you can view color-coded
          grades for a more organized view of your classes, GPA, 
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: tertiary.background, // Change to your preferred background color
  },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  headerText: {
    ...
    color: tertiary, // Change to your preferred text color
  ...
  circle: {
    position: 'absolute',
    top: '18%', // Adjust the top position as needed (percentage of the imageContainer height)
    left: '-10%', // Adjust the left position as needed (percentage of the imageContainer width)
    width: RFValue(72),
    height: RFValue(72),
    borderRadius: RFValue(100),
    backgroundColor: tertiary.tertiary, // Replace 'red' with your desired color for the circle
  },
  iOSHalfCircle: {
    position: 'absolute',
    top: '47.5%', // Adjust the top position as needed (percentage of the imageContainer height)
  ...
  halfCircleBottom: {
    flex: 1,
    backgroundColor: tertiary.tertiary, // Replace 'blue' with your desired color for the half circle
  ...
  androidHalfCircle: {
    ...
    right: '11%', // Adjust the right position as needed (percentage of the imageContainer width)
    width: RFValue(60),
    height: RFValue(120),
