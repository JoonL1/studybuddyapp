...
const OnboardingScreen = () => {
  ...
  const activeScreenIndex = 1; // Change this index based on the current active screen
      ...
      <View style={styles.imageContainer}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor: secondary.complement,
              borderRadius: 32,
              paddingVertical: 40,
              width: Dimensions.get('window').width - 56, // Set the width of the image container
            },
          ]}
        >
        </View>
        <Image
            source={require('../../assets/graphics/onboarding/onboarding2.png')}
        ...
        <View style={styles.textContainer}>
          ...
          We use smart prioritization to create auto to-do lists +
          calendars for you. Work on assignments straight from Canvas 
          using a timer in guided study sessions, which includes set periods 
          of study + rest.
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  androidHalfCircle: {
    ...
    right: '10.5%', // Adjust the right position as needed (percentage of the imageContainer width)
    width: RFValue(60),
    height: RFValue(120),
